  					...
  					if (in_array($definitions, $this->foreign_keys)){
  						if ($this->foreign_relations[$definitions][1] == $this::SELF){
  							if (is_null($row[$definitions]))
  								...
  								if ($this->recursive){
  									$this->fetch_id(array($this->foreign_relations[$definitions][0]=>$row[$definitions]));
  							...
  							if ($this->recursive){
    							$this->foreign_relations[$definitions][1]->fetch_id(array($this->foreign_relations[$definitions][0]=>$row[$definitions]));
